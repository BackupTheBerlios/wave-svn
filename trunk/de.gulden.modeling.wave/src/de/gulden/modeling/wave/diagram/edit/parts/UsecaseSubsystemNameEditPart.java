 ...
 * @generated
 */
public class UsecaseSubsystemNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public UsecaseSubsystemNameEditPart(View view) {
		super(view);
	}
			...
			parser = WaveParserProvider
					.getParser(
							...
							WaveVisualIDRegistry
									.getType(de.gulden.modeling.wave.diagram.edit.parts.UsecaseSubsystemNameEditPart.VISUAL_ID));
		}
		return parser;
	}
