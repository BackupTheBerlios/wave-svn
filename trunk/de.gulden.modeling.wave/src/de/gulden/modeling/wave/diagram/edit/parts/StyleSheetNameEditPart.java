 ...
 * @generated
 */
public class StyleSheetNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StyleSheetNameEditPart(View view) {
		super(view);
	}
			...
			parser = WaveParserProvider
					.getParser(
							...
							WaveVisualIDRegistry
									.getType(de.gulden.modeling.wave.diagram.edit.parts.StyleSheetNameEditPart.VISUAL_ID));
		}
		return parser;
	}
