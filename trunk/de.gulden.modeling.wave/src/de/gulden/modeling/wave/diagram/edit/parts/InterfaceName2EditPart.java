 ...
 * @generated
 */
public class InterfaceName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = WaveParserProvider
					.getParser(
							...
							WaveVisualIDRegistry
									.getType(de.gulden.modeling.wave.diagram.edit.parts.InterfaceName2EditPart.VISUAL_ID));
		}
		return parser;
	}
