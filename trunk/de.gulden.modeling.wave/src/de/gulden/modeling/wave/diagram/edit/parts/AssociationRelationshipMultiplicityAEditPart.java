 ...
 * @generated
 */
public class AssociationRelationshipMultiplicityAEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				WaveVisualIDRegistry
						.getType(de.gulden.modeling.wave.diagram.edit.parts.AssociationRelationshipMultiplicityAEditPart.VISUAL_ID),
				new Point(0, 60));
	}
	 ...
	 * @generated
	 */
	public AssociationRelationshipMultiplicityAEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new AssociationMultiplicityAFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationMultiplicityAFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationMultiplicityAFigure() {
			this.setText("");
		}
