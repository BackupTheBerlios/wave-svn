...
import de.gulden.modeling.wave.diagram.edit.policies.Class2ItemSemanticEditPolicy;
...
public class Class2EditPart extends de.gulden.modeling.wave.diagram.edit.parts.ClassEditPartBase {
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 13003;
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Class2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ClassName2EditPart) {
			((ClassName2EditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof de.gulden.modeling.wave.diagram.edit.parts.Class2EditPart) {
			types.add(WaveElementTypes.DependencyRelationship_3001);
		}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		...
		if (relationshipType == WaveElementTypes.DependencyRelationship_3001) {
			...
			types.add(WaveElementTypes.Interface_13004);
			types.add(WaveElementTypes.Include_13010);
		} else if (relationshipType == WaveElementTypes.RealizationRelationship_3003) {
			types.add(WaveElementTypes.Interface_2018);
			types.add(WaveElementTypes.Interface_13004);
