 ...
 * @generated
 */
public class DependencyRelationshipStereotype3EditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				WaveVisualIDRegistry
						.getType(de.gulden.modeling.wave.diagram.edit.parts.DependencyRelationshipStereotype3EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public DependencyRelationshipStereotype3EditPart(View view) {
		super(view);
	}
	...
	protected void refreshLabel() {
		setLabelTextHelper(getFigure(), de.gulden.modeling.wave.util.WaveUtil.toStereotype(getLabelText()));
