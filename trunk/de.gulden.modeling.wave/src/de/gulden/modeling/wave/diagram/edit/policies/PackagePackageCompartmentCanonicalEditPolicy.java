 ...
 * @generated
 */
public class PackagePackageCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return WavePackage.eINSTANCE.getPackage_Members();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<WaveNodeDescriptor> childDescriptors = WaveDiagramUpdater
				.getPackagePackageCompartment_7014SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<WaveNodeDescriptor> childDescriptors = WaveDiagramUpdater
				.getPackagePackageCompartment_7014SemanticChildren((View) getHost()
						.getModel());
