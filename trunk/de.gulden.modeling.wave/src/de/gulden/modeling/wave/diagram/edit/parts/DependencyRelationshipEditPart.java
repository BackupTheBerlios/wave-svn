...
import de.gulden.modeling.wave.diagram.edit.policies.DependencyRelationshipItemSemanticEditPolicy;

/**
 * @generated
 */
public class DependencyRelationshipEditPart extends ConnectionNodeEditPart
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DependencyRelationshipStereotypeEditPart) {
			((DependencyRelationshipStereotypeEditPart) childEditPart)
