...
import de.gulden.modeling.wave.diagram.edit.policies.Include2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Include2EditPart extends ShapeNodeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 13010;
	 ...
	 * @generated
	 */
	public Include2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Include2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new IncludeFigure();
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof IncludeName2EditPart) {
			((IncludeName2EditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof de.gulden.modeling.wave.diagram.edit.parts.Include2EditPart) {
			types.add(WaveElementTypes.DependencyRelationship_3001);
		}
		if (targetEditPart instanceof ClassEditPart) {
			types.add(WaveElementTypes.InheritanceRelationship_3002);
