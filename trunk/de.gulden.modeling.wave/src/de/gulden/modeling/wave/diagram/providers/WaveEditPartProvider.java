...
import de.gulden.modeling.wave.diagram.edit.parts.WaveEditPartFactory;
import de.gulden.modeling.wave.diagram.part.WaveVisualIDRegistry;

/**
 * @generated
 */
public class WaveEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public WaveEditPartProvider() {
		setFactory(new WaveEditPartFactory());
