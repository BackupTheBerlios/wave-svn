...
import de.gulden.modeling.wave.diagram.edit.policies.PackageItemSemanticEditPolicy;
...
public class PackageEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof de.gulden.modeling.wave.diagram.edit.parts.PackageEditPart) {
			types.add(WaveElementTypes.DependencyRelationship_3001);
		}
