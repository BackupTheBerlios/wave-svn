...
import de.gulden.modeling.wave.diagram.edit.policies.OperationItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OperationEditPart extends ClassifierMemberEditPartBase implements
		ITextAwareEditPart {
			...
			parser = WaveParserProvider
					.getParser(
							...
							WaveVisualIDRegistry
									.getType(de.gulden.modeling.wave.diagram.edit.parts.OperationEditPart.VISUAL_ID));
		}
		return parser;
	}
