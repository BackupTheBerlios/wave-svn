 ...
 * @generated
 */
public class DocumentationTextEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DocumentationTextEditPart(View view) {
		super(view);
	}
			...
			parser = WaveParserProvider
					.getParser(
							...
							WaveVisualIDRegistry
									.getType(de.gulden.modeling.wave.diagram.edit.parts.DocumentationTextEditPart.VISUAL_ID));
		}
		return parser;
	}
