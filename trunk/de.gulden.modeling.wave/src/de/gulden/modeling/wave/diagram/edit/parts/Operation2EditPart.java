...
import de.gulden.modeling.wave.diagram.edit.policies.Operation2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Operation2EditPart extends ClassifierMemberEditPartBase implements
		ITextAwareEditPart {
			...
			parser = WaveParserProvider
					.getParser(
							...
							WaveVisualIDRegistry
									.getType(de.gulden.modeling.wave.diagram.edit.parts.Operation2EditPart.VISUAL_ID));
		}
		return parser;
	}
