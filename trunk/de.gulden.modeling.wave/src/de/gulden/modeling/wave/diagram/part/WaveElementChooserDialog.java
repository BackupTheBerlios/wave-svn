 ...
 * @generated
 */
public class WaveElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public WaveElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.WaveElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "Wave".equals(fileExtension); //$NON-NLS-1$
	}
