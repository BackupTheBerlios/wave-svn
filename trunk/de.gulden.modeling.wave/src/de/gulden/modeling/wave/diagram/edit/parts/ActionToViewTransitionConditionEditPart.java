 ...
 * @generated
 */
public class ActionToViewTransitionConditionEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				WaveVisualIDRegistry
						.getType(de.gulden.modeling.wave.diagram.edit.parts.ActionToViewTransitionConditionEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ActionToViewTransitionConditionEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ActionToViewNameFigure();
	}

	/**
	 * @generated
	 */
	public class ActionToViewNameFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ActionToViewNameFigure() {
			this.setText("");
		}
