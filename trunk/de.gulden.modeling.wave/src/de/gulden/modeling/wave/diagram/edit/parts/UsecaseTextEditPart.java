 ...
 * @generated
 */
public class UsecaseTextEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public UsecaseTextEditPart(View view) {
		super(view);
	}
			...
			parser = WaveParserProvider
					.getParser(
							...
							WaveVisualIDRegistry
									.getType(de.gulden.modeling.wave.diagram.edit.parts.UsecaseTextEditPart.VISUAL_ID));
		}
		return parser;
	}
