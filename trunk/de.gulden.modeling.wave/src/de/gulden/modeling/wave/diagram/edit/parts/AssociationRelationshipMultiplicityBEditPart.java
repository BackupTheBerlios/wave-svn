 ...
 * @generated
 */
public class AssociationRelationshipMultiplicityBEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				WaveVisualIDRegistry
						.getType(de.gulden.modeling.wave.diagram.edit.parts.AssociationRelationshipMultiplicityBEditPart.VISUAL_ID),
				new Point(0, 80));
	}
	 ...
	 * @generated
	 */
	public AssociationRelationshipMultiplicityBEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new AssociationMultiplicityBFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationMultiplicityBFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationMultiplicityBFigure() {
			this.setText("");
		}
