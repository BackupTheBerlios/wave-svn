...
import de.gulden.modeling.wave.diagram.edit.policies.Operation5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Operation5EditPart extends ClassifierMemberEditPartBase implements
		ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Operation5ItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new WaveTextNonResizableEditPolicy());
			...
			parser = WaveParserProvider
					.getParser(
							...
							WaveVisualIDRegistry
									.getType(de.gulden.modeling.wave.diagram.edit.parts.Operation5EditPart.VISUAL_ID));
		}
		return parser;
	}
	 ...
	 * @generated
	 */
	protected void refreshXXXUnderline() {
