 ...
 * @generated
 */
public class ViewNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ViewNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WaveParserProvider
					.getParser(
							WaveElementTypes.View_13007,
							getParserElement(),
							WaveVisualIDRegistry
									.getType(de.gulden.modeling.wave.diagram.edit.parts.ViewNameEditPart.VISUAL_ID));
		}
		return parser;
	}
