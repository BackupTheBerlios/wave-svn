 ...
 * @generated
 */
public class IncludeName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public IncludeName2EditPart(View view) {
		super(view);
	}
			...
			parser = WaveParserProvider
					.getParser(
							...
							WaveVisualIDRegistry
									.getType(de.gulden.modeling.wave.diagram.edit.parts.IncludeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
