...
import de.gulden.modeling.wave.diagram.edit.policies.StyleSheetItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StyleSheetEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public StyleSheetEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new StyleSheetItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		StyleSheetFigure figure = new StyleSheetFigure();
	 ...
	 * @generated
	 */
	public StyleSheetFigure getPrimaryShape() {
		return (StyleSheetFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof StyleSheetNameEditPart) {
			((StyleSheetNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureStyleSheetNameFigure());
			return true;
		}
		return false;
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof de.gulden.modeling.wave.diagram.edit.parts.StyleSheetEditPart) {
			types.add(WaveElementTypes.DependencyRelationship_3001);
		}
	 ...
	 * @generated
	 */
	public class StyleSheetFigure extends Shape {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureStyleSheetNameFigure;

		/**
		 * @generated
		 */
		public StyleSheetFigure() {
		...
		private void createContents() {
			...
			fFigureStyleSheetNameFigure = new WrappingLabel();
			fFigureStyleSheetNameFigure.setText("");

			this.add(fFigureStyleSheetNameFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureStyleSheetNameFigure() {
			return fFigureStyleSheetNameFigure;
		}
