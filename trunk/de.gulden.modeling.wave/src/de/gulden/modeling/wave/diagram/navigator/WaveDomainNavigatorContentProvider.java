 ...
 * @generated
 */
public class WaveDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public WaveDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof WaveDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((WaveDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new WaveDomainNavigatorItem((EObject) objects[i],
