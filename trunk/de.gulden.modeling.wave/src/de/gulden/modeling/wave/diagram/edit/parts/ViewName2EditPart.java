 ...
 * @generated
 */
public class ViewName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ViewName2EditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		return WaveElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WaveParserProvider
					.getParser(
							WaveElementTypes.View_13002,
							getParserElement(),
							WaveVisualIDRegistry
									.getType(de.gulden.modeling.wave.diagram.edit.parts.ViewName2EditPart.VISUAL_ID));
		}
		return parser;
	}
