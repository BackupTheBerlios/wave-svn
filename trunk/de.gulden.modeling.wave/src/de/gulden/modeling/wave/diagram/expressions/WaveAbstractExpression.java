 ...
 * @generated
 */
public abstract class WaveAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = WaveDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected WaveAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
