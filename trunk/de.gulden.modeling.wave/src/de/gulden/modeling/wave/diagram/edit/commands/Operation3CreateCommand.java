...
public class Operation3CreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Operation newElement = WaveFactory.eINSTANCE.createOperation();

		ControllerMemberExecutable owner = (ControllerMemberExecutable) getElementToEdit();
		owner.setOperation(newElement);
