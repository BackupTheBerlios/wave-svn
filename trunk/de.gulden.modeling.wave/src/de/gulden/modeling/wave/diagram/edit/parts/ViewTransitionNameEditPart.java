 ...
 * @generated
 */
public class ViewTransitionNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				WaveVisualIDRegistry
						.getType(de.gulden.modeling.wave.diagram.edit.parts.ViewTransitionNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ViewTransitionNameEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ViewTransitionNameFigure();
	}

	/**
	 * @generated
	 */
	public class ViewTransitionNameFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ViewTransitionNameFigure() {
			this.setText("");
		}
