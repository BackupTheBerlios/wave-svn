 ...
 * @generated
 */
public class WaveNavigatorLinkHelper implements ILinkHelper {
	...
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = WaveDiagramEditorPlugin.getInstance()
	...
	public void activateEditor(IWorkbenchPage aPage,
		...
		WaveAbstractNavigatorItem abstractNavigatorItem = (WaveAbstractNavigatorItem) aSelection
				.getFirstElement();
		View navigatorView = null;
		if (abstractNavigatorItem instanceof WaveNavigatorItem) {
			navigatorView = ((WaveNavigatorItem) abstractNavigatorItem)
					.getView();
