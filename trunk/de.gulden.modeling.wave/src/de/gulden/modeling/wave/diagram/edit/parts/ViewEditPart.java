...
import de.gulden.modeling.wave.diagram.edit.policies.ViewItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ViewEditPart extends ShapeNodeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 13007;
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ViewItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ViewFigure();
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ViewNameEditPart) {
			((ViewNameEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof de.gulden.modeling.wave.diagram.edit.parts.ViewEditPart) {
			types.add(WaveElementTypes.DependencyRelationship_3001);
		}
