...
public class EnumerationImpl extends OOPClassifierImpl implements Enumeration {
	...
	protected EClass eStaticClass() {
		return WavePackage.Literals.ENUMERATION;
	}
	...
	public EList<EnumerationLiteral> getLiterals() {
		if (literals == null) {
			literals = new EObjectContainmentEList<EnumerationLiteral>(EnumerationLiteral.class, this, WavePackage.ENUMERATION__LITERALS);
		}
		return literals;
	}
