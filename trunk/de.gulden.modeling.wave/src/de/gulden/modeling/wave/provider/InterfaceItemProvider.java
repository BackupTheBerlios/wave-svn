...
/**
 * This is the item provider adapter for a {@link de.gulden.modeling.wave.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_targetMode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_targetMode_feature", "_UI_Interface_type"),
				 WavePackage.Literals.INTERFACE__TARGET_MODE,
				 true,
				 false,
				 false,
