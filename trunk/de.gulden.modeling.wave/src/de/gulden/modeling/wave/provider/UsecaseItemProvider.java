...
/**
 * This is the item provider adapter for a {@link de.gulden.modeling.wave.Usecase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UsecaseItemProvider
	extends UsecaseClassifierItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Usecase_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Usecase_text_feature", "_UI_Usecase_type"),
				 WavePackage.Literals.USECASE__TEXT,
				 true,
				 true,
				 false,
	...
	public String getText(Object object) {
		String label = crop(((Usecase)object).getText());
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Usecase.class)) {
			case WavePackage.USECASE__TEXT:
