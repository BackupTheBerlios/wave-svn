...
/**
 * This is the item provider adapter for a {@link de.gulden.modeling.wave.Form} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FormItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Form_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Form_operation_feature", "_UI_Form_type"),
				 WavePackage.Literals.FORM__OPERATION,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WavePackage.Literals.FORM__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WavePackage.Literals.FORM__WIDGETS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WavePackage.Literals.FORM__WIDGETS,
				 WaveFactory.eINSTANCE.createWidgetAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(WavePackage.Literals.FORM__WIDGETS,
				 WaveFactory.eINSTANCE.createWidgetAssociation()));
	}
