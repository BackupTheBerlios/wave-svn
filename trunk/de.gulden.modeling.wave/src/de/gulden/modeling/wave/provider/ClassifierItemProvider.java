...
/**
 * This is the item provider adapter for a {@link de.gulden.modeling.wave.Classifier} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassifierItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WavePackage.Literals.CLASSIFIER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addIsExternalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Classifier_isExternal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Classifier_isExternal_feature", "_UI_Classifier_type"),
				 WavePackage.Literals.CLASSIFIER__IS_EXTERNAL,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WavePackage.Literals.CLASSIFIER__OPERATIONS);
			childrenFeatures.add(WavePackage.Literals.CLASSIFIER__ATTRIBUTES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WavePackage.Literals.CLASSIFIER__OPERATIONS,
				 WaveFactory.eINSTANCE.createOperation()));

		newChildDescriptors.add
			(createChildParameter
				(WavePackage.Literals.CLASSIFIER__ATTRIBUTES,
				 WaveFactory.eINSTANCE.createAttribute()));
	}
