...
/**
 * This is the item provider adapter for a {@link de.gulden.modeling.wave.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider
	extends ClassifierMemberItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WavePackage.Literals.ATTRIBUTE__TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WavePackage.Literals.ATTRIBUTE__DEFAULT_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addIsMultiplePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_isMultiple_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_isMultiple_feature", "_UI_Attribute_type"),
				 WavePackage.Literals.ATTRIBUTE__IS_MULTIPLE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = de.gulden.modeling.wave.util.WaveUtil.getAttributeLabel((Attribute)object);
