...
/**
 * This is the item provider adapter for a {@link de.gulden.modeling.wave.StyleSheet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StyleSheetItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StyleSheet_code_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StyleSheet_code_feature", "_UI_StyleSheet_type"),
				 WavePackage.Literals.STYLE_SHEET__CODE,
				 true,
				 true,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StyleSheet.class)) {
			case WavePackage.STYLE_SHEET__CODE:
