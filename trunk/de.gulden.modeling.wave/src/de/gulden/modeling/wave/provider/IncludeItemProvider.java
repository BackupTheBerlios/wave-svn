...
/**
 * This is the item provider adapter for a {@link de.gulden.modeling.wave.Include} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Include_code_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Include_code_feature", "_UI_Include_type"),
				 WavePackage.Literals.INCLUDE__CODE,
				 true,
				 true,
				 false,
	...
	protected void addUrlPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Include_urlPath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Include_urlPath_feature", "_UI_Include_type"),
				 WavePackage.Literals.INCLUDE__URL_PATH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
