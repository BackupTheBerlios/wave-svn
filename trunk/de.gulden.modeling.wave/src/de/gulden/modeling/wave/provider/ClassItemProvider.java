...
/**
 * This is the item provider adapter for a {@link de.gulden.modeling.wave.Class} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassItemProvider
	extends OOPClassifierItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Class_isPersistent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Class_isPersistent_feature", "_UI_Class_type"),
				 WavePackage.Literals.CLASS__IS_PERSISTENT,
				 true,
				 false,
				 false,
	...
	protected void addTargetModePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Class_targetMode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Class_targetMode_feature", "_UI_Class_type"),
				 WavePackage.Literals.CLASS__TARGET_MODE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WavePackage.Literals.CLASS__FORMS);
		}
	...
	public String getText(Object object) {
		String label = ((de.gulden.modeling.wave.Class)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WavePackage.Literals.CLASS__FORMS,
				 WaveFactory.eINSTANCE.createForm()));
	}
