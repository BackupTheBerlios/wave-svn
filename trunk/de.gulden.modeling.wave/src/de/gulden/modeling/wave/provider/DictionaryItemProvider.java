...
/**
 * This is the item provider adapter for a {@link de.gulden.modeling.wave.Dictionary} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DictionaryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dictionary_defaultLang_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dictionary_defaultLang_feature", "_UI_Dictionary_type"),
				 WavePackage.Literals.DICTIONARY__DEFAULT_LANG,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WavePackage.Literals.DICTIONARY__LABEL);
		}
	...
	public String getText(Object object) {
		String label = ((Dictionary)object).getDefaultLang();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WavePackage.Literals.DICTIONARY__LABEL,
				 WaveFactory.eINSTANCE.createLabel()));
	}
